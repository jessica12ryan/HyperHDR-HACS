...
![hyperhdr-logo](https://github.com/jessica12ryan/HyperHDR-HACS/blob/master/hyperhdr-logo.png)

## Installation

### Using HACS

1. Add <https://github.com/jessica12ryan/HyperHDR-HACS> to your [HACS](https://hacs.xyz/) custom repositories.
...
1. Visit the Wiki for information regarding: 
    - [Initial Setup](https://github.com/jessica12ryan/HyperHDR-HACS/wiki#initial-setup)
    - [Post-setup Advice](https://github.com/jessica12ryan/HyperHDR-HACS/wiki#post-setup-advice)
    - [Debug Logging](https://github.com/jessica12ryan/HyperHDR-HACS/wiki#debug-logging)

### Manually (not recommended)

- Download the [latest release](https://github.com/jessica12ryan/HyperHDR-HACS/releases) as a **zip file** then extract it and move the `hyperhdr` folder into the `custom_components` folder in your Home Assistant installation.
